...
/// The mastery metrics come – as with <see cref="LearnGoal"/> – from a learning-progress snapshot loaded
/// once (<see cref="ChildLearnProgressService.ScopeEvaluator"/>), the grade metric from the recorded
