...
namespace Pugling.Api.Data.Migrations
{
    ...
    [Migration("20260727224348_RemarkComments")]
    partial class RemarkComments
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Pugling.Api.Models.CreatorProfile", b =>
                {
                    ...
                    b.HasIndex("OwnerFatherId", "Name")
                        .IsUnique()
                        .HasFilter("[OwnerFatherId] IS NOT NULL");
            ...
            modelBuilder.Entity("Pugling.Api.Models.CreatorProfile", b =>
                {
                    b.HasOne("Pugling.Api.Models.Father", "Owner")
                        .WithMany()
                        .HasForeignKey("OwnerFatherId")
                        .OnDelete(DeleteBehavior.SetNull);
