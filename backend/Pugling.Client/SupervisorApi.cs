...
public sealed class SupervisorApi(HttpClient http)
{
    ...
    /// <summary>Outcome goals of a child on catalog scope (live-evaluated).</summary>
    ...
    /// <summary>Creates a learn goal.</summary>
    ...
    /// <summary>Updates a learn goal.</summary>
    ...
    /// <summary>Deletes a learn goal.</summary>
    ...
    /// <summary>Objectives (OKR wrapper around the learn goals) of a child.</summary>
