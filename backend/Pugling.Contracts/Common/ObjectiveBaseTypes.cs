...
/// they reward repeating rather than proficiency and would be farmable. The coverage-based "Coverage" (value 1 of the
/// related <c>LearnGoalMetric</c>) is deliberately missing here: it already rises from merely seeing vocabulary.
/// </summary>
