...
{
    public class VocabularyPersit(IVocabularyDbService<VocabularyEntity, VocabularyEntity> _vocabularyDbService, ILogger<VocabularyPersit> _logger) : IVocabularyDbService<VocabularyDto, Vocabulary>
    {
