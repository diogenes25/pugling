...
| --- | --- | --- | --- | --- | --- | --- | --- |
| [B-82](B-82-positions-report-gibt-loesungen-preis.md) | Über den Positions-Report kann ein Kind die Lösung jeder Karte lesen | Defekt | `in-arbeit` | P1 | M | beides | Vertrag |
