...
public class VocabularyTests
{
    ...
    public void Create_WithValidParameters_ReturnsExpectedInstanceTest()
    {
        ...
        var partOfSpeech = PugLing.Model.Models.Constants.EPartOfSpeech.Verb;
    ...
    public void Create_FromIVocabulary_ReturnsExpectedInstanceTest()
    {
        ...
        mockVocabulary.Setup(m => m.PartOfSpeech).Returns(PugLing.Model.Models.Constants.EPartOfSpeech.Verb);
        ...
        // Act
        var result = Vocabulary.Create("en", "de", mockVocabulary.Object, null);
    ...
    {
        // Arrange
        var vocabulary1 = Vocabulary.Create("1", "run", "laufen", PugLing.Model.Models.Constants.EPartOfSpeech.Verb, "en", "de");
        var vocabulary2 = Vocabulary.Create("1", "run", "laufen", PugLing.Model.Models.Constants.EPartOfSpeech.Verb, "en", "de");
    ...
    public void Equals_WithDifferentValues_ReturnsFalseTest()
    {
        // Arrange
        var vocabulary1 = Vocabulary.Create("1", "run", "laufen", PugLing.Model.Models.Constants.EPartOfSpeech.Verb, "en", "de");
        var vocabulary2 = Vocabulary.Create("2", "walk", "gehen", PugLing.Model.Models.Constants.EPartOfSpeech.Verb, "en", "de");
